    ...
    if (Firebase.getString(firebaseData, path))
     {
      ...
      int pin = firebaseData.stringData().toInt();
      int pininput = getEnteredAmount(); 
      if(pininput==pin)
     {

      int espuserBalance = firebaseData.stringData().toInt();
      ...
      if (Firebase.getString(firebaseData, balancePath))
       {
        ...
        Firebase.setString(firebaseData, balancePath, String(updatedBalance));
        Firebase.setString(firebaseData, amountPath, String(amount));
        Firebase.setString(firebaseData, espPath, String(espuserBalance));
